...
<table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
    <thead>
        <tr style="background-color: #f3f4f6;">
            <th style="padding: 12px; border: 1px solid #e5e7eb; text-align: left;">Task Name</th>
    ...
    <tbody>
        ...
        <tr>
            <td style="padding: 12px; border: 1px solid #e5e7eb;">{{ $task['name'] }}</td>
            <td style="padding: 12px; border: 1px solid #e5e7eb; text-align: center;">{{ $task['estimated_time'] }}</td>
            <td style="padding: 12px; border: 1px solid #e5e7eb; text-align: center;">{{ $task['real_time'] }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
...
<p>If you believe the issue is not fully resolved or if you have further questions, feel free to reply to this email or open a new support request.</p>
